## Weather_App
This is the React Weather App project it provides real-time weather updates for any city or country using the OpenWeather API. Built with React and styled with Tailwind CSS, this app is designed to be sleek, responsive and user-friendly.
...
## Deploy on Vercel
 - **Deployed Link** - `https://weather-app-orpin-gamma-47.vercel.app/`
